...
export class RegisterComponent implements OnInit {
  ...
  register(event: Event): void {
    ...
    const passwordAgain = (target.querySelector('#password-again') as HTMLInputElement).value;
    const fullName = (target.querySelector('#fullname') as HTMLInputElement).value;
