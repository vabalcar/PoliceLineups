...
import { loadAllLineups } from "src/app/state/lineups/lineups-list/lineups-list.actions";
import { selectLineupsList } from "src/app/state/lineups/lineups-list/lineups-list.selectors";

@Component({
  templateUrl: "./all-lineups-list.component.html",
})
export class AllLineupsListComponent implements OnInit {
  @ViewChild(MatSort)
  ...
  ngOnInit(): void {
    this.store.dispatch(loadAllLineups());
  }
}
